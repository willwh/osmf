	...
	public class SMILParser
	{
		...
		private function parseMediaElement(mediaXml:XML):MediaElement
		{
			...
			if (mediaXml != null)
			{
				...
				{
					media = new VideoElement(new NetLoader(),new URLResource(new URL(mediaXml.@src)));						
				}
				else if(tagName == "audio")
				{
					media = new AudioElement(new NetLoader(), new URLResource(new URL(mediaXml.@src)));
				}
				else if(tagName == "image")
				{
					media = new ImageElement(new ImageLoader(), new URLResource(new URL(mediaXml.@src)));
				}
			}
