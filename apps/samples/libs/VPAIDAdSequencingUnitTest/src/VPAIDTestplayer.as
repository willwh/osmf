package {
	...
	public class VPAIDTestplayer extends Sprite
	{
		...
		public function VPAIDTestplayer()
		{
			...
			layout.snapToPixel = false;
			serialElement.addMetadata(LayoutMetadata.LAYOUT_NAMESPACE, layout);
