...
package org.osmf.chrome.controlbar.widgets
{
	...
	{
		[Embed("../assets/images/scrubber_up.png")]
		public var scrubberUpType:Class;
		[Embed("../assets/images/scrubber_down.png")]
		public var scrubberDownType:Class;
		[Embed("../assets/images/scrubber_disabled.png")]
		public var scrubberDisabledType:Class;
		
		public function Scrubber(up:Class = null, down:Class = null, disabled:Class = null)
		{
			up ||= scrubberUpType;
			down ||= scrubberDownType;
			disabled ||= scrubberDisabledType;
