...
package org.osmf.elements.f4mClasses
{
	...
	public class TestMediaParser extends TestCase
	{
		...
		public function testMediaParser():void
		{
			var test:XML = <media url="http://example.com/myvideo/low"
								  ...
								  width="640"
								  height="480"
								  drmAdditionalHeaderId="drmMetadata2052"/>;
		...
		private function verifyParse(event:ParseEvent):void
		{
			...
			assertEquals("http://example.com/myvideo/low", media.url);
			assertTrue(media.drmAdditionalHeader != null);
		...
		public function ignore_testXMPMoovParsing():void
		{
			...
			var test:XML =  <media url="low"  bitrate="408" width="640" height="480" >
								<xmpMetadata>
									{xmpEncoded}
								</xmpMetadata>	
								<moov>
		...
		private function verifyXMPMoovParse(event:ParseEvent):void
		{
			...
			assertEquals(media.moov.toString(), "testMoov");
			assertEquals(media.xmp.toString(), "testXMP");	
		}
		...
		private function verifyMetadata(event:ParseEvent):void
		{
			...
			for ( var key:Object in media.metadata)
			{
				if (media.metadata[key] is String ||
					media.metadata[key] is Number )
				{
					assertEquals(media.metadata[key] , metaInfo[key]);
				}
			}
		}
		...
		{
			var test:XML = <media url="rtmfp://weiz-xp1/multicast"
			...
			test = <media url="rtmfp://weiz-xp1/multicast"
						  groupspec="G:010121055e884898da28047151d0e56f8dc6292773603d0d6aabbdd62a11ef721d1542d8010c170e6f72672e6f736d662e6e65742e6d756c746963617374210e61b67506b6a5f02187ca24fe590388778040fa3a9c23589c58baadd097c12657011b00070ae00000fe814b"/>;
