...
{
	/**
	 * URL parses a Uniform Resource Indentifier (URI/URL) into individual properties and provides easy access
	...
	public class URL
	{
		...
		public function set rawUrl(value:String):void
		{
			_rawUrl = value;
			if (_rawUrl && _rawUrl.length)
			{
