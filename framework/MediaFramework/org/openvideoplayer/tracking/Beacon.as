...
package org.openvideoplayer.tracking
{
	 ...
	 * 
	 * @eventType org.openvideoplayer.events.BeaconEvent.PING_COMPLETE
	 */
	[Event(name="pingComplete",type="org.openvideoplayer.events.BeaconEvent")]

	/**
	 * Dispatched when the Beacon's HTTP request has failed.
	 * 
	 * @eventType org.openvideoplayer.events.BeaconEvent.PING_FAILED
	 */
	[Event(name="pingFailed",type="org.openvideoplayer.events.BeaconEvent")]
