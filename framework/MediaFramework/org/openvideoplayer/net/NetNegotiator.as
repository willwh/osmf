...
package org.openvideoplayer.net
{
	 ...
	 *
	 * @eventType org.openvideoplayer.events.NetNegotiatorEvent.CONNECTED
	 * 
	 **/
	[ Event( name="connected", type="org.openvideoplayer.events.NetNegotiatorEvent") ]
	
	/**
	 * Dispatched when the negotiator has failed to connect
	 *
	 * @eventType org.openvideoplayer.events.NetNegotiatorEvent.CONNECTION_FAILED
	 * 
	 **/
	[ Event( name="connectionfailed", type="org.openvideoplayer.events.NetNegotiatorEvent") ]
	...
	public class NetNegotiator extends EventDispatcher 
	{
		 ...
		 * 
		 * @see org.openvideoplayer.utils.FMSURL
		 **/
		...
		protected function buildConnectionAddress(url:URL, protocol:String, port:String):String
		{
			...
			return protocol + "://" + fmsURL.host + ":" + port + "/" + fmsURL.appName;
		}
