...
package org.openvideoplayer.net
{
	 ...
	 *
	 * @eventType org.openvideoplayer.events.NetConnectionFactoryEvent.CREATED
	 * 
	 **/
	[Event(name="created", type="org.openvideoplayer.events.NetConnectionFactoryEvent")]
	
	/**
	 * Dispatched when the factory has failed to create and connect a NetConnection
	 *
	 * @eventType org.openvideoplayer.events.NetConnectionFactoryEvent.CREATION_FAILED
	 * 
	 **/
	[Event(name="creationfailed", type="org.openvideoplayer.events.NetConnectionFactoryEvent")]
	...
	public class NetConnectionFactory extends EventDispatcher
	{
		 ...
		 * manage previously shared connecitons as well as pending connections. Only if a NetConenction is not shareable
		 ...
		 * @param allowNetConnectionSharing Boolean specifiying whether the NetConnection may be shared or not
		 * 
		 * @see org.openvideoplayer.events.MediaErrorEvent;
		 * @see org.openvideoplayer.events.MediaError
		 * @see NetNegotiator
		 */
		...
		/**
		 * Generates a key to uniquely indentify each connection. 
		 * 
