...
package org.openvideoplayer.metadata
{
	 ...
	 * These classes are strored on all IMediaResources as initial information relating to the media.  
	 * Example of metadata content include: title, size, language, and subject.  
	 */ 
	public interface IFacet
	{
		/**
		 * Return the type of facet this view of metadata is.
		 */
		function get facetType():FacetType;
		
		/**
		 * The namespace that corresponds to the schema for this metadata
		 */ 
		function get nameSpace():URL;
	}
}