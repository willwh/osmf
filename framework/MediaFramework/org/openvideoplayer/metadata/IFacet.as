...
package org.openvideoplayer.metadata
{
	 ...
	 * 
	 * @eventType org.openvideoplayer.events.FacetEvent.VALUE_ADD
	 */
     [Event(name='facetValueAdd', type='org.openvideoplayer.events.FacetValueEvent')]
	
     /**
	 * Signals that all of the IFacets's values have changed.
	 * 
	 * @eventType org.openvideoplayer.events.FacetEvent.VALUE_REMOVE
	 */
     [Event(name='facetValueRemove', type='org.openvideoplayer.events.FacetEvent')]
