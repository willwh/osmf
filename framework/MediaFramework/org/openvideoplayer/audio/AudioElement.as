	...
	public class AudioElement extends LoadableMediaElement
	{
		...
		override protected function processLoadedState():void
		{
			...
			else    // Progressive
			{
				...
				soundAdapter.addEventListener(SoundAdapter.PLAYBACK_ERROR, onPlaybackError);
		...
		{
			dispatchEvent(new MediaErrorEvent(new MediaError(MediaErrorCodes.PLAY_FAILED, MediaFrameworkStrings.AUDIO_PLAYBACK_FAILED)));
		}
