...
package org.openvideoplayer.media
{
	...
	import org.openvideoplayer.utils.DynamicReferenceMediaElement;
	...
	public class TestIMediaFactory extends InterfaceTestCase
	{
		...
		public function testAddMediaInfo():void
		{
			...
			var mediaInfo1:IMediaInfo = createMediaInfo(id);
			...
			// to be replaced.
			var mediaInfo2:IMediaInfo = createMediaInfo(id);
		...
		public function testGetNumMediaInfos():void
		{
			...
			var info1:IMediaInfo = createMediaInfo("a1");
			var info2:IMediaInfo = createMediaInfo("a2");
			var info3:IMediaInfo = createMediaInfo("b3", null, null, MediaInfoType.PROXY);
			var info4:IMediaInfo = createMediaInfo("b4", null, null, MediaInfoType.PROXY);
		...
		public function testGetMediaInfoAt():void
		{
			...
			var b1:IMediaInfo = createMediaInfo("b1","http://www.example.com/b1", null, MediaInfoType.PROXY);
			var b2:IMediaInfo = createMediaInfo("b2","http://www.example.com/b2", null, MediaInfoType.PROXY);
			var b3:IMediaInfo = createMediaInfo("b3","http://www.example.com/b3", null, MediaInfoType.PROXY);
		...
		{
			var standardInfo:IMediaInfo = createMediaInfo("standardInfo", "http://www.example.com/standardInfo");
			...
			var invalidProxyInfo:IMediaInfo = createMediaInfo("invalidProxyInfo", "http://www.example.com/standardInfo", null, MediaInfoType.PROXY);
			...
			// media element.
			var validProxyInfo:IMediaInfo = createProxyMediaInfo("validProxyInfo", "http://www.example.com/standardInfo");
			...
			var deepProxyInfo:IMediaInfo = createProxyMediaInfo("deepProxyInfo", "http://www.example.com/standardInfo");
		...
		public function testCreateMediaElementWithReference():void
		{
			var standardInfo:IMediaInfo = createMediaInfo("standardInfo","http://www.example.com/standardInfo");
			mediaFactory.addMediaInfo(standardInfo);
			var otherStandardInfo:IMediaInfo = createMediaInfo("otherStandardInfo","http://www.example.com/otherStandardInfo");
			...
			var invalidReferenceInfo:IMediaInfo = createMediaInfo("invalidReferenceInfo", "http://www.example.com/invalidReferenceInfo");
			...
			// created one.
			var referenceInfo:IMediaInfo = createReferenceMediaInfo("referenceInfo1","http://www.example.com/referenceInfo1", ["http://www.example.com/standardInfo"]);
			...
			var yetAnotherStandardInfo:IMediaInfo = createMediaInfo("yetAnotherStandardInfo","http://www.example.com/yetAnotherStandardInfo");
		...
		private function createMediaInfo(id:String, urlToMatch:String=null, args:Array=null, type:MediaInfoType=null):IMediaInfo
		{
		...
		private function createProxyMediaInfo(id:String, urlToMatch:String=null, args:Array=null):IMediaInfo
		{
			return new MediaInfo
					( id
					, new SampleResourceHandler((urlToMatch ? null : canHandleResource), urlToMatch) 
		...
		private function createReferenceMediaInfo(id:String, urlToMatch:String=null, args:Array=null, type:MediaInfoType=null):IMediaInfo
		{
			return new MediaInfo
					( id
					, new SampleResourceHandler((urlToMatch ? null : canHandleResource), urlToMatch) 
					, DynamicReferenceMediaElement
					, args != null ? args : []
					, type != null ? type : MediaInfoType.STANDARD
					);
		}
