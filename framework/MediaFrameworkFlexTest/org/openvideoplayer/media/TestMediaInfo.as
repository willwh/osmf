...
package org.openvideoplayer.media
{
	...
	public class TestMediaInfo extends TestCase
	{
		...
		public function testCreateMediaElement():void
		{
			...
			var mediaElement:MediaElement = mediaInfo.createMediaElement(VALID_RESOURCE);
			assertTrue(mediaElement != null);
			assertTrue(mediaElement.resource == VALID_RESOURCE);
			...
			mediaElement = mediaInfo.createMediaElement(VALID_RESOURCE);
			assertTrue(mediaElement != null);
			...
			// This should fail to create the element because the MediaInfo
			// doesn't handle this resource.
			//
			
			mediaElement = mediaInfo.createMediaElement(INVALID_RESOURCE);
			assertTrue(mediaElement == null);
